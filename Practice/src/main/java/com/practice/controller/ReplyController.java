...
public class ReplyController {
	...
	public ResponseEntity<String> create(@RequestBody ReplyVO vo){
		log.info("ReplyController : <Post> create");
	...
	public ResponseEntity<Replies>getList(@PathVariable("bno")Long bno,@PathVariable("page")int page){
		log.info("ReplyController : <Get> getList "+bno+" "+page);
	...
	public ResponseEntity<ReplyVO>get(@PathVariable("rno")Long rno){
		log.info("ReplyController : <Get> get "+rno);
		return new ResponseEntity<>(service.get(rno),HttpStatus.OK);
	}
	
	@DeleteMapping(value="/{rno}",produces= {MediaType.TEXT_PLAIN_VALUE})
	public ResponseEntity<String>remove(@PathVariable("rno")Long rno){
		log.info("ReplyController : <Delete> remove "+rno);
	...
	public ResponseEntity<String>modify(@RequestBody ReplyVO vo,@PathVariable("rno")Long rno){
		vo.setRno(rno);
		log.info("ReplyController : <PUT of PATCH> modify "+vo);
